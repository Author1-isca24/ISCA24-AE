...
OBJSET_cache: enum{cache0, cache1, cache2, cache3};
...
ruleset adr:Address do
  ...
  rule "Unlocking cache_I"
    ...
    & (forall d:OBJSET_directory0 do (
        ...
        | i_directory0[d].CL[adr].State = directory_E
  ...
  rule "Unlocking cache_E"
    cle.State = cache_E & !(MultiSetCount(l:lock_set_cache, lock_set_cache[l] = m) = 0)
    & (forall d:OBJSET_directory0 do (
        i_directory0[d].CL[adr].State = directory_I
        | i_directory0[d].CL[adr].State = directory_S
        | i_directory0[d].CL[adr].State = directory_E
  ...
  endrule;
    ...
    & (forall d:OBJSET_directory1 do (
        ...
        | i_directory1[d].CL[adr].State = directory_E
