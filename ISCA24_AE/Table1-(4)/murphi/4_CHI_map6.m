...
--Backend/Murphi/MurphiModular/GenTypes
  type
    ...
    ----Backend/Murphi/MurphiModular/Types/GenMachineSets
      ...
      OBJSET_cacheL1C1: scalarset(1);
      -- OBJSET_cache2: scalarset(2);
      OBJSET_cache2: enum{cache10, cache11};
      
      Machines: union{OBJSET_directoryL1C1, OBJSET_directory1L1C1, OBJSET_cache2, OBJSET_cacheL1C1};
...
-------------buf--------------------------------
    ...
    ----Backend/Murphi/MurphiModular/Types/GenMachines
      ...
      v_cache2: multiset[NrCachesL1C1] of Machines;
      cnt_v_cache2: 0..NrCachesL1C1;
      ...
      OBJ_cache2: array[OBJSET_cache2] of MACH_cacheL1C1;
...
--Backend/Murphi/MurphiModular/GenFunctions
  ...
  ----Backend/Murphi/MurphiModular/Functions/GenResetFunc
    ...
    begin
      for i:OBJSET_directoryL1C1 do
        for a:Address do
          ...
          undefine i_directoryL1C1[i].cb[a].cache2;
      ...
      for i:OBJSET_directory1L1C1 do
        for a:Address do
          ...
          undefine i_directory1L1C1[i].cb[a].cache2;
    ...
    begin
      ...
      for i:OBJSET_cache2 do
        for a:Address do
          i_cache2[i].cb[a].State := cacheL1C1_I;
          i_cache2[i].cb[a].cl := 0;
  ...
  ----Backend/Murphi/MurphiModular/Functions/GenVectorFunc
    ...
    procedure AddElement_cache2(var sv:v_cache2; n:Machines);
    begin
        if MultiSetCount(i:sv, sv[i] = n) = 0 then
          MultiSetAdd(n, sv);
        endif;
    ...
    procedure RemoveElement_cache2(var sv:v_cache2; n:Machines);
    begin
        if MultiSetCount(i:sv, sv[i] = n) = 1 then
          MultiSetRemovePred(i:sv, sv[i] = n);
        endif;
    ...
    procedure ClearVector_cache2(var sv:v_cache2;);
    begin
        MultiSetRemovePred(i:sv, true);
    end;
    ...
    function IsElement_cache2(var sv:v_cache2; n:Machines) : boolean;
    begin
        if MultiSetCount(i:sv, sv[i] = n) = 1 then
          return true;
        elsif MultiSetCount(i:sv, sv[i] = n) = 0 then
    ...
    function VectorCount_cache2(var sv:v_cache2) : cnt_v_cache2;
    begin
        return MultiSetCount(i:sv, true);
    end;
...
procedure Send_snp(msg:Message; src: Machines;);
  ...
  if IsMember(msg.dst,  OBJSET_cacheL1C1) then
    if (msg.adr = 0) then
      ...
      snp[1][cnt_snp[1]] := msg;
      cnt_snp[1] := cnt_snp[1] + 1;
    endif;
  endif;

  if IsMember(msg.dst,  OBJSET_cache2) then
      -- snp[0][cnt_snp[0]] := msg;
      -- cnt_snp[0] := cnt_snp[0] + 1;
    if (msg.dst = cache10) then
      snp[0][cnt_snp[0]] := msg;
      cnt_snp[0] := cnt_snp[0] + 1;
    elsif (msg.dst = cache11) then
      snp[1][cnt_snp[1]] := msg;
      cnt_snp[1] := cnt_snp[1] + 1;
    endif;   
...
procedure Pop_dat(n:0..1;);
    ...
    procedure Multicast_snp_v_cache2(var msg: Message; dst_vect: v_cache2; src: Machines;);
    begin
          for n:Machines do
              if n!=msg.src then
                if MultiSetCount(i:dst_vect, dst_vect[i] = n) = 1 then
...
--Backend/Murphi/MurphiModular/GenStateMachines
  ...
  ----Backend/Murphi/MurphiModular/StateMachines/GenAccessStateMachines
    procedure FSM_Access_cache2_E_evict(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
    ...
    procedure FSM_Access_cache2_E_load(adr:Address; m:OBJSET_cache2);
    begin
    alias cbe: i_cache2[m].cb[adr] do
      cbe.State := cacheL1C1_E;
    endalias;
    ...
    procedure FSM_Access_cache2_E_store(adr:Address; m:OBJSET_cache2);
    begin
    alias cbe: i_cache2[m].cb[adr] do
      cbe.State := cacheL1C1_M;
    endalias;
    ...
    procedure FSM_Access_cache2_I_load(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
    ...
    procedure FSM_Access_cache2_I_store(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
    ...
    procedure FSM_Access_cache2_M_evict(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
    ...
    procedure FSM_Access_cache2_M_load(adr:Address; m:OBJSET_cache2);
    begin
    alias cbe: i_cache2[m].cb[adr] do
      cbe.State := cacheL1C1_M;
    endalias;
    ...
    procedure FSM_Access_cache2_M_store(adr:Address; m:OBJSET_cache2);
    begin
    alias cbe: i_cache2[m].cb[adr] do
      cbe.State := cacheL1C1_M;
    endalias;
    ...
    procedure FSM_Access_cache2_O_evict(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
      if (adr = 0) then
    ...
    procedure FSM_Access_cache2_O_load(adr:Address; m:OBJSET_cache2);
    begin
    alias cbe: i_cache2[m].cb[adr] do
      cbe.State := cacheL1C1_O;
    endalias;
    ...
    procedure FSM_Access_cache2_O_store(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
    ...
    procedure FSM_Access_cache2_S_evict(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
    ...
    procedure FSM_Access_cache2_S_load(adr:Address; m:OBJSET_cache2);
    begin
    alias cbe: i_cache2[m].cb[adr] do
      cbe.State := cacheL1C1_S;
    endalias;
    ...
    procedure FSM_Access_cache2_S_store(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
    ...
    procedure FSM_Access_cache2_UCE_evict(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
    ...
    procedure FSM_Access_cache2_UCE_load(adr:Address; m:OBJSET_cache2);
    var msg: Message;
    begin
    alias cbe: i_cache2[m].cb[adr] do
    ...
    procedure FSM_Access_cache2_UCE_store(adr:Address; m:OBJSET_cache2);
    begin
    alias cbe: i_cache2[m].cb[adr] do
      cbe.State := cacheL1C1_M;
    endalias;
    ...
    switch cbe.State
      ...
      switch inmsg.mtype
        ...
        case ReadSharedL1C1:
          ...
          if IsMember(cbe.ownerL1C1, OBJSET_cacheL1C1) then
          AddElement_cacheL1C1(cbe.cacheL1C1, cbe.ownerL1C1);
          elsif IsMember(cbe.ownerL1C1, OBJSET_cache2) then
          AddElement_cache2(cbe.cache2, cbe.ownerL1C1);
          endif;

          if IsMember(inmsg.src, OBJSET_cacheL1C1) then
          AddElement_cacheL1C1(cbe.cacheL1C1, inmsg.src);
          elsif IsMember(inmsg.src, OBJSET_cache2) then
          AddElement_cache2(cbe.cache2, inmsg.src);
          endif;
      ...
      switch inmsg.mtype
        case CleanUniqueL1C1:
          cbe.acksExpectedL1C1 := VectorCount_cacheL1C1(cbe.cacheL1C1) + VectorCount_cache2(cbe.cache2);
          if (IsElement_cacheL1C1(cbe.cacheL1C1, inmsg.src) | IsElement_cache2(cbe.cache2, inmsg.src)) then
            ...
            if (cbe.acksExpectedL1C1 != 0) then
              if !(IsElement_cacheL1C1(cbe.cacheL1C1, inmsg.src) | IsElement_cache2(cbe.cache2, inmsg.src)) then
                ...
                Multicast_snp_v_cache2(msg, cbe.cache2, m);
              ...
              if IsMember(inmsg.src, OBJSET_cacheL1C1) then
                ...
                RemoveElement_cache2(cbe.cache2, inmsg.src);  
              endif;            
                -- RemoveElement_cacheL1C1(cbe.cacheL1C1, inmsg.src);
        ...
        case EvictL1C1:
          ...
          Send_rsp(msg, m);
          if (IsElement_cacheL1C1(cbe.cacheL1C1, inmsg.src) | IsElement_cache2(cbe.cache2, inmsg.src)) then
            if ((VectorCount_cacheL1C1(cbe.cacheL1C1) + VectorCount_cache2(cbe.cache2)) = 1) then
      ...
      switch inmsg.mtype
        case CleanUniqueL1C1:
          ...
          if !(IsElement_cacheL1C1(cbe.cacheL1C1, cbe.ownerL1C1) | IsElement_cache2(cbe.cache2, cbe.ownerL1C1)) then
            cbe.acksReceivedL1C1 := 0;
            if (cbe.acksExpectedL1C1 != 0) then
              if (IsElement_cacheL1C1(cbe.cacheL1C1, cbe.ownerL1C1) | IsElement_cache2(cbe.cache2, cbe.ownerL1C1)) then
              ...
              if IsMember(cbe.ownerL1C1, OBJSET_cacheL1C1) then
                ...
                RemoveElement_cache2(cbe.cache2, cbe.ownerL1C1);  
              endif;     
...
----------- cache function end--------------------------------------------------------------------
  ...
  function FSM_MSG_cache2(inmsg:Message; m:OBJSET_cache2) : boolean;
    var msg: Message;
    begin
      alias adr: inmsg.adr do
      alias cbe: i_cache2[m].cb[adr] do
...
--Backend/Murphi/MurphiModular/GenRules
  ----Backend/Murphi/MurphiModular/Rules/GenAccessRuleSet
    ...
    ruleset adr:Address do
      ...
      ==>
        FSM_Access_cache2_E_evict(adr, m);
      ...
      rule "cache2_E_load"
        cbe.State = cacheL1C1_E 
      ==>
        FSM_Access_cache2_E_load(adr, m);
      ...
      rule "cache2_E_store"
        cbe.State = cacheL1C1_E 
      ==>
        FSM_Access_cache2_E_store(adr, m);
      ...
      ==>
        FSM_Access_cache2_I_store(adr, m);
      ...
      rule "cache2_I_load"
        cbe.State = cacheL1C1_I & network_ready() 
      ==>
        FSM_Access_cache2_I_load(adr, m);
      ...
      rule "cache2_M_load"
        cbe.State = cacheL1C1_M 
      ==>
        FSM_Access_cache2_M_load(adr, m);
      ...
      rule "cache2_M_store"
        cbe.State = cacheL1C1_M 
      ==>
        FSM_Access_cache2_M_store(adr, m);
      ...
      ==>
        FSM_Access_cache2_M_evict(adr, m);
      ...
      rule "cache2_O_load"
        cbe.State = cacheL1C1_O 
      ==>
        FSM_Access_cache2_O_load(adr, m);
      ...
      ==>
        FSM_Access_cache2_O_store(adr, m);
      ...
      rule "cache2_O_evict"
        cbe.State = cacheL1C1_O & network_ready() 
      ==>
        FSM_Access_cache2_O_evict(adr, m);
      ...
      ==>
        FSM_Access_cache2_S_evict(adr, m);
      ...
      rule "cache2_S_store"
        cbe.State = cacheL1C1_S & network_ready() 
      ==>
        FSM_Access_cache2_S_store(adr, m);
      ...
      rule "cache2_S_load"
        cbe.State = cacheL1C1_S 
      ==>
        FSM_Access_cache2_S_load(adr, m);
        
      endrule;
    
      rule "cache2_UCE_evict"
        cbe.State = cacheL1C1_UCE & network_ready() 
      ==>
        FSM_Access_cache2_UCE_evict(adr, m);
        
      endrule;
    
      rule "cache2_UCE_store"
        cbe.State = cacheL1C1_UCE 
      ==>
        FSM_Access_cache2_UCE_store(adr, m);
        
      endrule;
    
      rule "cache2_UCE_load"
        cbe.State = cacheL1C1_UCE & network_ready() 
      ==>
        FSM_Access_cache2_UCE_load(adr, m);
  ...
  alias p:buf_snp[n] do
      ...
      ==>
        alias msg:p.Queue[0] do
          ...
          if IsMember(n, OBJSET_cache2) then -- ismember should decide the id of marhicnes
            if FSM_MSG_cache2(msg, n) then
              PopQueue(buf_snp, n);
            endif;
          endif;
