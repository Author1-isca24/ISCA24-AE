...
OBJSET_cache1: enum{cache10, cache11};
...
if IsMember(inmsg.src, OBJSET_cache1) then
------------------------------------------------------------------------------------------------------------------------
  if (IsElement_v_NrCaches_OBJSET_cache1(cle.cache,inmsg.src)) then
    if IsMember(inmsg.src, OBJSET_cache1) then
    RemoveElement_v_NrCaches_OBJSET_cache1(cle.cache,inmsg.src);
    else
    RemoveElement_v_NrCaches_OBJSET_cache0(cle.cache0,inmsg.src);
...
------------------------------------------------------------------------------------------------------------------------
elsif IsMember(inmsg.src, OBJSET_cache0) then
------------------------------------------------------------------------------------------------------------------------
  if (IsElement_v_NrCaches_OBJSET_cache0(cle.cache0,inmsg.src)) then
    if IsMember(inmsg.src, OBJSET_cache1) then
    RemoveElement_v_NrCaches_OBJSET_cache1(cle.cache,inmsg.src);
    else
    RemoveElement_v_NrCaches_OBJSET_cache0(cle.cache0,inmsg.src);
...
procedure SEND_cache_E_evict0(adr:Address; m:OBJSET_cache0);
var msg: Message;
begin
  alias cle: i_cache0[m].CL[adr] do
    if (adr = 0) then
...
procedure SEND_cache_E_evict1(adr:Address; m:OBJSET_cache1);
var msg: Message;
begin
  alias cle: i_cache1[m].CL[adr] do
    if (adr = 0) then
...
----- cache send function ----- ----- ----- ----- ----- 
procedure SEND_cache_E_load0(adr:Address; m:OBJSET_cache0);
var msg: Message;
begin
  alias cle: i_cache0[m].CL[adr] do
    cle.State := cache_E;
...
procedure SEND_cache_E_load1(adr:Address; m:OBJSET_cache1);
var msg: Message;
begin
  alias cle: i_cache1[m].CL[adr] do
    cle.State := cache_E;
...
----- cache send function ----- ----- ----- ----- ----- 
procedure SEND_cache_E_store0(adr:Address; m:OBJSET_cache0);
var msg: Message;
begin
  alias cle: i_cache0[m].CL[adr] do
    cle.State := cache_M;
...
procedure SEND_cache_E_store1(adr:Address; m:OBJSET_cache1);
var msg: Message;
begin
  alias cle: i_cache1[m].CL[adr] do
    cle.State := cache_M;
